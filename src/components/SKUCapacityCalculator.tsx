  ...
  return (
    <div className="space-y-4">
          ...
          <div className="col-span-1 flex items-center gap-2">
            ...
            {calculatedResult !== null && (
              <button
                ...
                className="py-1.5 px-2.5 rounded-xl bg-[#EEE8D5] hover:bg-[#E4DDC7] text-[#073642] font-bold text-xs border border-[#D6D1B1] transition-all flex items-center justify-center gap-1 cursor-pointer"
                title="Reset"
              >
          ...
          <div className="pt-1 space-y-2.5">
            <div className="p-3.5 rounded-xl bg-[#EEE8D5] border border-[#D6D1B1] flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              ...
              <div className="bg-[#FDF6E3] p-2.5 rounded-lg border border-[#D6D1B1] text-xs">
                <span className="text-[#586E75] block text-[9px] uppercase font-bold">
      ...
      {inventoryBottlenecks.length > 0 ? (
        <div className="bg-[#FFFBEB] border border-amber-400 text-[#073642] rounded-xl px-3.5 py-2 shadow-xs flex flex-col lg:flex-row lg:items-center justify-between gap-2.5 animate-in fade-in">
          {/* Left: Scaled Header Label */}
          <div className="flex items-center gap-2 shrink-0">
            <AlertTriangle className="w-4 h-4 text-amber-600 shrink-0 animate-pulse" />
            <span className="text-xs font-black text-[#073642] whitespace-nowrap">
            ...
            {inventoryBottlenecks.map(item => (
              ...
              >
                <div className="flex items-center gap-1.5">
                  <span className="font-bold text-[#073642] text-xs max-w-[140px] truncate">
                    {item.name}
                  </span>
                ...
                <span className="text-[10px] text-[#586E75] font-mono font-medium border-l border-amber-300/80 pl-2">
                  <strong className="text-[#073642]">{item.currentStock}</strong>/{item.targetThreshold}
        ...
        <div className="bg-emerald-50 border border-emerald-300 text-emerald-950 rounded-xl px-3.5 py-2 flex items-center justify-between shadow-xs text-xs">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-[#073642]">
