      ...
      <div className="bg-[#FFFFFF] w-full max-w-2xl rounded-3xl p-6 border border-[#E2E8F0] shadow-2xl space-y-5 my-8">
        ...
        <div className="flex items-center justify-between border-b border-[#E2E8F0]/60 pb-4">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-emerald-500/15 text-[#8db600] border border-[#8db600]/30 flex items-center justify-center font-bold">
            ...
            <div>
              ...
              <p className="text-xs text-[#8db600] font-semibold">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full bg-[#FFFFFF] border border-[#E2E8F0] rounded-xl pl-10 pr-4 py-2.5 text-xs text-[#0D0D0D] focus:outline-none focus:border-[#8db600] font-medium"
          />
        </div>
              ...
              return (
                <div
                  ...
                  className={`p-3.5 rounded-2xl border flex flex-col sm:flex-row sm:items-center justify-between gap-3 transition-all ${
                    isSelected
                      ? 'bg-emerald-50/90 border-[#8db600] text-[#0D0D0D] shadow-sm'
                ...
                >
                  ...
                  >
                    <input
                      ...
                      checked={isSelected}
                      onChange={() => {}}
                      className="w-4 h-4 text-[#8db600] rounded focus:ring-[#8db600] shrink-0"
                    />
                    <div className="space-y-0.5">
                      ...
                      <div className="text-[11px] text-[#334155] flex items-center gap-3">
                        <span>Stock: <strong className="text-[#8db600]">{item.in_stock_qty || 100} {item.uom}</strong></span>
                  ...
                  {isSelected && (
                    <div className="flex items-center gap-2 shrink-0 bg-[#FFFFFF] p-1.5 rounded-xl border border-[#8db600] shadow-xs">
                      ...
                      <input
                        ...
                        className="w-16 font-mono font-bold text-xs bg-[#FFFFFF] border border-[#E2E8F0] rounded-lg px-2 py-1 text-center text-[#0D0D0D] focus:outline-none focus:border-[#8db600]"
                      />
        ...
        <div className="flex items-center justify-between pt-3 border-t border-[#E2E8F0]/60">
          <span className="text-xs text-[#8db600] font-bold">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              type="button"
              onClick={handleSave}
              className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#8db600] hover:bg-[#709200] text-black font-black text-xs shadow-md shadow-[#8db600]/20 active:scale-95 transition-all"
            >
