...
export const ComponentComparisonPage: React.FC<Props> = ({
  ...
  if (!component) {
    return (
      <div className="bg-[#FFFFFF] border border-[#E2E8F0] rounded-2xl p-12 text-center text-[#0D0D0D]">
        <Package className="w-12 h-12 mx-auto text-[#64748b] mb-3" />
        <h3 className="text-xl font-bold text-[#0D0D0D]">Component Not Found</h3>
        <p className="text-xs text-[#334155] mt-1 mb-6">
    ...
    <div className="space-y-6 animate-in fade-in duration-200">
      ...
      <div className="bg-[#FFFFFF] border border-[#E2E8F0] rounded-2xl p-5 shadow-xs">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6 border-t md:border-t-0 md:border-l border-[#E2E8F0]/60 pt-3 md:pt-0 md:pl-6 shrink-0 text-xs">
            <div>
              <span className="text-[10px] text-[#334155] uppercase font-bold block">In-Stock</span>
              <span className="text-sm font-extrabold text-[#0D0D0D] font-mono">
      ...
      <div className="bg-[#FFFFFF] border border-[#E2E8F0] rounded-2xl shadow-sm overflow-hidden flex flex-col">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs border-collapse">
            <thead>
              <tr className="border-b border-[#E2E8F0] bg-slate-50/80 text-[#0D0D0D] uppercase text-[11px] font-bold tracking-wider select-none">
            ...
            <tbody className="divide-y divide-[#E2E8F0]/60">
              {sortedCompanies.map((link, idx) => {
                ...
                return (
                  <tr
                    key={link.id}
                    className="bg-[#FFFFFF] hover:bg-slate-50/70 border-b border-[#E2E8F0] text-[#0D0D0D] transition-colors group"
                  >
                    {/* Numbering: Sequential index 1, 2, 3... */}
                    <td className="py-4 px-4 text-center font-mono font-bold text-[#334155]">
                      <span className="w-6 h-6 rounded-full bg-[#FFFFFF] text-[#0D0D0D] border border-[#E2E8F0] inline-flex items-center justify-center text-xs">
                        {idx + 1}
                      </span>
                    </td>
                    ...
                    <td className="py-4 px-5">
                      ...
                      <div className="text-[11px] text-[#334155] flex items-center gap-2 mt-0.5">
              ...
              {sortedCompanies.length === 0 && (
                <tr>
                  <td colSpan={6} className="py-12 px-6 text-center text-[#334155]">
                    <Building2 className="w-10 h-10 mx-auto text-[#64748b] mb-2 opacity-50" />
                    <p className="text-sm font-bold text-[#0D0D0D]">No Companies Linked Yet</p>
